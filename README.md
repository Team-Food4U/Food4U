...
| Database           | Supabase (PostgreSQL) for menus, tags, and daily updates |
| AI Layer           | OpenAI GPT-4 API to interpret user requests into structured filters |
| Search & Ranking   | Combines filters with semantic search (embeddings) to return the most relevant foods |
